...
// Target account seed: first 12 rows of Pat's tiered territory target list.
// The full 84-row file is at samples/pat-target-accounts.csv.
export const targetSampleCsv = "organization,contact,title,email,vertical,notes\nPMTraining,,,,Target account,\"Gold-tier target account. Delaware; annual revenue $7,200,000; 100,000 active users/members; 100,000 learners; last activity 17/10/2025. Owner: Pat Ducoffe.\"\nAmerican Concrete Institute,,,,Target account,\"Gold-tier target account. Michigan; annual revenue $22,000,000; 35,000 active users/members; last activity 01/04/2026. Owner: Pat Ducoffe.\"\nThe Ohio Society of CPA's,,,,Target account,\"Gold-tier target account. Ohio; annual revenue $9,075,687; 85,000 active users/members; last activity 12/02/2026. Owner: Pat Ducoffe.\"\nThe CPCU Society,,,,Target account,\"Gold-tier target account. annual revenue $18,134,000; 22,000 active users/members. Owner: Pat Ducoffe.\"\nOhio State Bar Association,,,,Target account,\"Gold-tier target account. annual revenue $10,880,737; 30,000 active users/members; last activity 12/12/2024. Owner: Pat Ducoffe.\"\nSAE International,,,,Target account,\"Gold-tier target account. Pennsylvania; annual revenue $52,800,000; 128,000 active users/members; last activity 20/02/2026. Owner: Pat Ducoffe.\"\nPerformance Review Institute,,,,Target account,\"Gold-tier target account. annual revenue $42,682,639; 20,000 learners; last activity 26/08/2025. Owner: Pat Ducoffe.\"\nAmerican College of Physicians,,,,Target account,\"Gold-tier target account. annual revenue $74,204,242; 160,000 active users/members; 300,000 learners; last activity 01/04/2026. Owner: Pat Ducoffe.\"\nDrug Information Association,,,,Target account,\"Gold-tier target account. annual revenue $16,483,000; last activity 27/01/2026. Owner: Pat Ducoffe.\"\nDevelopment Dimensions International,,,,Target account,\"Gold-tier target account. annual revenue $161,942,444; last activity 13/03/2026. Owner: Pat Ducoffe.\"\nAmerican Institute for Chartered Property Casualty Underwriters,,,,Target account,\"Gold-tier target account. annual revenue $82,000,000; 30,000 active users/members; last activity 13/02/2026. Owner: Pat Ducoffe.\"\nNational Federation of Independent Business,,,,Target account,\"Gold-tier target account. Tennessee; annual revenue $91,127,701; last activity 26/01/2026. Owner: Pat Ducoffe.\"\n";
...
export const importSamples: ImportSample[] = [
  ...
  {
    id: "target-accounts",
    label: "Target accounts (territory)",
    description: "84 tiered target accounts (DE, KY, MI, MN, OH, PA, TN, WI) \u2014 prospect research.",
    sourceName: "Pat\u2019s Target Account List \u2013 territory",
    purpose: "prospect_research",
    data: targetSampleCsv
  }
];
